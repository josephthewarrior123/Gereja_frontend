    ...
    return (
        <div style={{
            ...
            <style>{`
                ...
                * { box-sizing: border-box; }
                ...
                .gchip:hover {
                    ...
                    box-shadow: 0 4px 14px rgba(108,99,224,0.12);
                }
                .gchip.on {
                    border-color: var(--c);
            ...
            <div className="ob-hero" style={{
                    ...
                    <div style={{
                        ...
                        <div style={{
                            ...
                            <svg width="86" height="86" viewBox="0 0 86 86" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <text x="10" y="22" fontSize="6" fill="white" opacity="0.5">•</text>
                                <text x="74" y="20" fontSize="6" fill="white" opacity="0.5">•</text>
                            </svg>
                        </div>
                    </div>
                </div>
                ...
                <div style={{ textAlign: 'center', paddingBottom: 22, marginTop: 8 }}>
                    ...
                    <p style={{ color: 'rgba(255,255,255,0.65)', fontSize: 13, fontWeight: 600, margin: 0 }}>
                        Hai, <strong style={{ color: '#fff' }}>{user?.fullName || user?.username}</strong>! 👋 Pilih grup yang ingin kamu ikuti
                    </p>
                </div>
            </div>
            ...
            <div className="ob-card" style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 14 }}>
                    ...
                    {selected.length > 0 && (
                        <span style={{
                            ...
                            border: '1.5px solid rgba(108,99,224,0.2)',
                        ...
                        {groups.map((g) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <span style={{
                                        fontSize: 13, fontWeight: isOn ? 800 : 600,
                                        color: isOn ? '#1a1a2e' : '#8888a0',
                                        fontFamily: '"Nunito",sans-serif',
                ...
                {/* Submit */}
                <button className="ob-btn" onClick={handleSubmit} disabled={selected.length === 0 || submitting}>
                    {submitting ? (
                        <>
